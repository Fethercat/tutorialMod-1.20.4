...
public class ModBiomes {
    public static final RegistryKey<Biome> RUBY_LAND = RegistryKey.of(RegistryKeys.BIOME,
            new Identifier(TutorialMod.MOD_ID, "ruby_land"));

    public static void bootstrap(Registerable<Biome> context) {
        context.register(RUBY_LAND, rubyLand(context));
    }
    ...
    public static Biome rubyLand(Registerable<Biome> context) {
