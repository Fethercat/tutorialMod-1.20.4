package net.shadowedleaves.tutorialmod.entity.custom;
...
import net.shadowedleaves.tutorialmod.entity.ai.PorcupineAttackGoal;
...
public class PorcupineEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.25D,
                Ingredient.ofItems(ModItems.CORN), false));
